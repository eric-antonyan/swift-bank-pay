  ...
  return (
    <motion.div initial={{opacity: 0, marginTop: "50px"}} animate={{opacity: 1, marginTop: "64px"}} exit={{opacity: 0, marginTop: "60px"}} className='flex flex-col items-center gap-[36px]'>
      ...
      <form onSubmit={onSubmit} action="#" style={{maxWidth: "505px"}} className='w-[100%] px-[30px] flex flex-col gap-[30px]'>
        ...
        <FloatingInput setPasswordIsShowed={setPasswordIsShowed} passwordIsShowed={passwordIsShowed} advancedType={'password'} onChange={(e) => setPassword(e.target.value)} value={password} type={passwordIsShowed ? "text" : "password"} placeholder={'Password'} labelId={'password'} />
        <div className='relative'>
          <div className='flex justify-between items-center mb-[36px]'>
            ...
            <Link className='font-medium text-[14px]' to="/fp">Forgot password?</Link>
          </div>
